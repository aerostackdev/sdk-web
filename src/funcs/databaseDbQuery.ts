...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DbQueryResponse$inboundSchema),
    M.json([400, 401], operations.DbQueryResponse$inboundSchema),
    M.json(500, operations.DbQueryResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
